Refinery::Resources.configure do |config|
  ...
  config.max_file_size = 1044428800
  ...
  # config.dragonfly_secret = "036ca435f5fadcef3223ff56a64de38a0217adfd11265680"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:format"
  # config.datastore_root_path = "/home/sg552/workspace/personal_site/public/system/refinery/resources"
